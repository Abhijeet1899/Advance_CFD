...
int main()
{
	...
	SIP_Pinv_r(N,N_j,ap,aw,as,an,ae,r,Pinvxr);
	...
	do
	{
		...
		SIP_Pinv_r(N,N_j,ap,aw,as,an,ae,r,Pinvxr);//updating Pinverse * r values in Pinvxr column vector
